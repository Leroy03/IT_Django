...
class Chapter4TemplatesStructureTests(TestCase):
    ...
    def test_templates_directory_exists(self):
        ...
        self.assertTrue(
            directory_exists, f"{FAILURE_HEADER}Your project's templates directory does not exist.{FAILURE_FOOTER}")
    ...
    def test_rango_templates_directory_exists(self):
        ...
        self.assertTrue(
            directory_exists, f"{FAILURE_HEADER}The Rango templates directory does not exist.{FAILURE_FOOTER}")
    ...
    def test_template_dir_setting(self):
        ...
        self.assertTrue(
            variable_exists, f"{FAILURE_HEADER}Your settings.py module does not have the variable TEMPLATE_DIR defined!{FAILURE_FOOTER}")
    ...
    def test_template_lookup_path(self):
        ...
        self.assertTrue(
            found_path, f"{FAILURE_HEADER}Your project's templates directory is not listed in the TEMPLATES>DIRS lookup list. Check your settings.py module.{FAILURE_FOOTER}")
    ...
    def test_templates_exist(self):
        ...
        self.assertTrue(os.path.isfile(
            index_path), f"{FAILURE_HEADER}Your index.html template does not exist, or is in the wrong location.{FAILURE_FOOTER}")
        self.assertTrue(os.path.isfile(
            about_path), f"{FAILURE_HEADER}Your about.html template does not exist, or is in the wrong location.{FAILURE_FOOTER}")
...
class Chapter4StaticMediaTests(TestCase):
    ...
    def test_does_static_directory_exist(self):
        ...
        does_images_static_dir_exist = os.path.isdir(
            os.path.join(self.static_dir, 'images'))
        does_rango_jpg_exist = os.path.isfile(
            os.path.join(self.static_dir, 'images', 'rango.jpg'))
    ...
    def test_does_media_directory_exist(self):
        ...
        does_cat_jpg_exist = os.path.isfile(
            os.path.join(self.media_dir, 'cat.jpg'))
        ...
        self.assertTrue(
            does_cat_jpg_exist, f"{FAILURE_HEADER}We couldn't find the cat.jpg image in /media/. Check the file extension; this is a common pitfall. It should .jpg. Not .png, .gif, or .jpeg!{FAILURE_FOOTER}")
    ...
    def test_static_and_media_configuration(self):
        ...
        self.assertTrue(
            static_dir_exists, f"{FAILURE_HEADER}Your settings.py module does not have the variable STATIC_DIR defined.{FAILURE_FOOTER}")
        ...
        self.assertTrue(
            media_dir_exists, f"{FAILURE_HEADER}The MEDIA_DIR variable in settings.py has not been defined.{FAILURE_FOOTER}")
        ...
        self.assertTrue(
            media_root_exists, f"{FAILURE_HEADER}The MEDIA_ROOT setting has not been defined.{FAILURE_FOOTER}")
        ...
        self.assertTrue(
            media_url_exists, f"{FAILURE_HEADER}The setting MEDIA_URL has not been defined in settings.py.{FAILURE_FOOTER}")
...
class Chapter4ExerciseTests(TestCase):
    ...
    def setUp(self):
        ...
        self.template_dir = os.path.join(
            self.project_base_dir, 'templates', 'rango')
    ...
    def test_about_template_exists(self):
        ...
        """
        template_exists = os.path.isfile(
            os.path.join(self.template_dir, 'about.html'))
        self.assertTrue(
            template_exists, f"{FAILURE_HEADER}The about.html template was not found in the expected location.{FAILURE_FOOTER}")
    ...
    def test_about_contains_cat(self):
        ...
        print(required_pattern in self.about_response.content.decode())
        self.assertTrue(required_pattern in self.about_response.content.decode(
